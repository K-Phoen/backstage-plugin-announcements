...
import { AnnouncementCollatorFactory } from '@absa-common/plugin-announcements-backend';
...
import { AnnouncementSearchResultListItem } from '@absa-common/plugin-announcements';
